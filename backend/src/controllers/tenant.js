// backend/src/controllers/tenant.js
...
// Access: Manager, Owner, Admin
// ===================================
export const updateTenancyStatus = catchAsync(async (req, res, next) => {
  const { id } = req.params;
...
// Access: Admin only
// ===================================
export const removeTenancy = catchAsync(async (req, res, next) => {
  const { id } = req.params;
...
// Access: Manager, Owner, Admin
// ===================================
export const getPropertyTenants = catchAsync(async (req, res, next) => {
...
// Access: Manager, Owner, Admin
// ===================================
export const getTenantHistory = catchAsync(async (req, res, next) => {
  const { propertyId } = req.params;
...
// Access: Tenant only
// ===================================
export const getMyLease = catchAsync(async (req, res, next) => {
  if (!req.user) {
