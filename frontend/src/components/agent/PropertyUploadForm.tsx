          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full rounded-md border-gray-700 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50"
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300">Year Built</label>
              <input
                type="number"
                name="yearBuilt"
            ...
            <div>
              ...
              <div className="mt-1 flex rounded-md shadow-sm">
                <input
                  ...
                  className="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-l-md border-gray-700 focus:ring-primary focus:border-primary sm:text-sm"
                />
                <button
                  type="button"
                  onClick={addFeature}
        ...
        <div className="pt-5">
          <div className="flex justify-end space-x-3">
            <button
              ...
              className="bg-surface py-2 px-4 border border-gray-700 rounded-md shadow-sm text-sm font-medium text-gray-300 hover:bg-background focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
              Cancel
            </button>
            <button
